...
class Hsv(ctk.CTkToplevel):
    ...
    def __init__(self, parent, draw_image_func, on_apply_func):
        ...
        LabeledSlider(self, text='Hue', variable=self.h, s_range=(-100, 100)).grid(row=0, column=0, columnspan=3, padx=10, sticky='nsew')
        LabeledSlider(self, text='Saturation', variable=self.s, s_range=(-100, 100)).grid(row=1, column=0, columnspan=3, padx=10, sticky='nsew')
        LabeledSlider(self, text='Value', variable=self.v, s_range=(-100, 100)).grid(row=2, column=0, columnspan=3, padx=10, sticky='nsew')
